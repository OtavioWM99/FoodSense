...
export default function LoginScreen() {
    ...
    return (
        ...
        >
            ...
            <View>
                {/* Input Email */}
                <Text className="text-white font-poppinsMedium" style={{ fontSize: moderateScale(18), marginBottom: verticalScale(6) }}>Insira seu email</Text>
                ...
                {/* Input Senha */}
                <Text className="text-white font-poppinsMedium" style={{ fontSize: moderateScale(18), marginBottom: verticalScale(6) }}>Insira sua senha</Text>
                <TextInput style={{ fontSize: moderateScale(15), width: scale(250), padding: moderateScale(8), marginBottom: verticalScale(25) }}
                value={senha}
            ...
            <View style={{ 
                ...
                {/* Botão Continuar */}
                <TouchableOpacity style={{ width: scale(250), height: verticalScale(40), backgroundColor: "#949494", marginBottom: verticalScale(12) }}
                    onPress={handleLogin}
                ...
                {/* Botão Voltar */}
                <TouchableOpacity style={{ width: scale(250), height: verticalScale(40), backgroundColor: "#C2C2C2" }}
